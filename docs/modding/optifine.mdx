...
## Added notes*
For any game version you want to implement Optifine into, you need to hav eit positively installed, and make sure you have run it just once before you proceed to install the Opstifine using its ".jar" file. Thank you!
